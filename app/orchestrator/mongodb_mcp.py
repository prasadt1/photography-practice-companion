"""Load MongoDB MCP Server as ADK McpToolset (optional — requires npx + mcp-config.json)."""
...
def load_mongodb_mcp_toolset():
    ...
    Set ORCHESTRATOR_USE_MCP=false to skip (FunctionTools still query MongoDB).
    """
    ...
    try:
        ...
        logger.warning("MCP dependencies missing: %s", exc)
        return None
